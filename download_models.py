...
if __name__ == '__main__':
    ...
    model_dir = snapshot_download('opendatalab/PDF-Extract-Kit-1.0', local_dir='./Pdf-Extract-Kit', allow_patterns=mineru_patterns)
    layoutreader_model_dir = snapshot_download('ppaanngggg/layoutreader', local_dir='./Pdf-Extract-Kit')
    ...
    home_dir = os.path.join(os.path.dirname(__file__), 'Pdf-Extract-Kit') 
